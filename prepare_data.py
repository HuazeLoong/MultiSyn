...
def creat_data(datafile,cellfile1, cellfile2):
    ...
    MyTestDataset(root=DATA_DIR, dataset=datafile + '_drug1', xd=drug1, xt=cell, xt_feature1=cell_features1, xt_feature2=cell_features2, y=label, smile_graph=smile_pharm_graph)
    MyTestDataset(root=DATA_DIR, dataset=datafile + '_drug2', xd=drug2, xt=cell, xt_feature1=cell_features1, xt_feature2=cell_features2, y=label, smile_graph=smile_pharm_graph)
